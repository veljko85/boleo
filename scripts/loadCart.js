      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let boleo180180GrauCart = 0;
            let boleo90180GrauCart = 0;
            let boleoKosaGrauCart = 0;
            for (let i = 0; i < allFences.length; i++) {
              //   if (fencesArr[i].color == "larche") {
              //     if (allFences[i][0].isVisible) sina180180LarcheCart += 1;
              //     if (allFences[i][1].isVisible) sina90180LarcheCart += 1;
              //     if (allFences[i][2].isVisible) sina18090LarcheCart += 1;
              //     if (allFences[i][3].isVisible) sinaKosaLarcheCart += 1;
              //     if (allFences[i][4].isVisible) sinaKosaLarcheCart += 1;
              //   }
              if (fencesArr[i].color == "grau") {
                if (allFences[i][0].isVisible) boleo180180GrauCart += 1;
                if (allFences[i][1].isVisible) boleo90180GrauCart += 1;
                if (allFences[i][2].isVisible) boleoKosaGrauCart += 1;
                if (allFences[i][3].isVisible) boleoKosaGrauCart += 1;
              }
            }
            ...
            let woodenPost190Grau = 0;
            let woodenPost95Grau = 0;
            for (let i = 0; i < allWoodPosts.length; i++) {
              if (allWoodPosts[i].isVisible) {
                console.log(allWoodPosts[i].scaling.y);
            ...
            for (let i = 0; i < allPosts.length; i++) {
              if (allPosts[i].isVisible) {
                console.log(allPosts[0].scaling.z);
            ...
            metalParts.forEach((elm) => {
              if (elm.isVisible) metalPartsCart += 1;
            });
            //cart items
            cartItems = [];
            cartItems.push(
